...
class OrganizerAdd extends React.Component { 
    ...
    handleColor = obj => {let color = obj.color; this.state.value.color = color}
    ...
    const {organizer, title, description, time, duration, addToDo} = this.props;
  ...
  <div className={styles.component}>
    ...
    <Link className={styles.back} to ={`${process.env.PUBLIC_URL}/projects/organizer`}>X</Link>
      <div className ={styles.form}>
      	<input type='text' name='title'  className={styles.title} onChange={this.handleChange} placeholder='Add title'/>
      	<input type='textarea' name='description' className={styles.description} onChange={this.handleChange} placeholder='Describe your task'/>
     ...
     <Link className={styles.add} to ={`${process.env.PUBLIC_URL}/projects/organizer`} onClick={e => {
       {addToDo(this.state.value)} }}>Add event!</Link>
      </div>
    </div>
    <Button text='Go back' />
  </div>
